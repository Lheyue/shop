...
.login-box{width:410px;margin:120px auto 0 auto;text-align:center;padding:30px;background:url(./include/login/images/mask.png);border-radius:10px;}
...
<script type="text/javascript" src="./include/login/js/jquery-1.8.2.min.js"></script>
...
<div class="login-box">
	<h1>商城后台登录</h1>
	<form method="post" action="./include/login/action.php">
		<div class="name">
			<label>管理员账号：</label>
...
<div class="screenbg">
	<ul>
		<li><a href="javascript:;"><img src="./include/login/images/0.jpg"></a></li>
		<li><a href="javascript:;"><img src="./include/login/images/1.jpg"></a></li>
		<li><a href="javascript:;"><img src="./include/login/images/2.jpg"></a></li>
	</ul>
</div>
