...
<div class="shop-goods">
        <!--  购物车商品列表 -->
          <dl>
            <dt>
                <span class="col col-4">ID</span>
                <span class="col col-4">订单id</span>
                <span class="col col-4">商品id</span>
                <span class="col col-4">商品名字</span>
                <span class="col col-4">价格</span> 
				<span class="col col-4">数量</span>
			...
			<?php
				...
				// echo $sql;
				 ...
				 while($list=mysqli_fetch_assoc($res))
				 {
					echo " <dl>";
					echo "<dt>";
					 echo "<span class='col col-4'>{$list['id']}</span>";
					 echo "<span class='col col-4'>{$list['orderid']}</span>";
					 echo "<span class='col col-4'>{$list['goodsid']}</span>";
					 echo "<span class='col col-4'>{$list['name']}</span>";
					 echo "<span class='col col-4'>{$list['price']}</span>";
					 echo "<span class='col col-4'>{$list['num']}</span>";
					 echo "<span class='col col-5'><a href='action.php?id={$list['orderid']}'>确认收货</a></span>";
        ...
        <div class="checkout-price">
                <p class="checkout-total">应付总额：<span><strong id="d_all_amount"><?php echo $total; ?></strong>元</span></p>
